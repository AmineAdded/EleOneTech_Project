...
export class CommandeService {
  ...
  searchByArticleRefAndDateSouhaitee(
    articleRef: string,
    date: string
  ): Observable<CommandeResponse[]> {
    return this.http.get<CommandeResponse[]>(
      `${this.apiUrl}/search/article/${articleRef}/date-souhaitee/${date}`
    );
  }

  searchByArticleRefAndDateAjout(articleRef: string, date: string): Observable<CommandeResponse[]> {
    return this.http.get<CommandeResponse[]>(
      `${this.apiUrl}/search/article/${articleRef}/date-ajout/${date}`
    );
  }

  // ✅ NOUVEAU: Recherche par période
  searchByArticleRefAndPeriodeSouhaitee(
    articleRef: string,
    dateDebut: string,
    dateFin: string
  ): Observable<CommandeResponse[]> {
    ...
    return this.http.get<CommandeResponse[]>(
      `${this.apiUrl}/search/article/${articleRef}/periode-souhaitee`,
      { params }
    );
  }

  searchByArticleRefAndPeriodeAjout(
    articleRef: string,
    dateDebut: string,
    dateFin: string
  ): Observable<CommandeResponse[]> {
    const params = new HttpParams().set('dateDebut', dateDebut).set('dateFin', dateFin);
    return this.http.get<CommandeResponse[]>(
      `${this.apiUrl}/search/article/${articleRef}/periode-ajout`,
      { params }
    );
  }
  ...
  getSummaryByArticleRefAndDateSouhaitee(
    articleRef: string,
    date: string
  ): Observable<CommandeSummaryResponse> {
    return this.http.get<CommandeSummaryResponse>(
      `${this.apiUrl}/summary/article/${articleRef}/date-souhaitee/${date}`
    );
  }

  getSummaryByArticleRefAndDateAjout(
    articleRef: string,
    date: string
  ): Observable<CommandeSummaryResponse> {
    return this.http.get<CommandeSummaryResponse>(
      `${this.apiUrl}/summary/article/${articleRef}/date-ajout/${date}`
    );
  }

  // ✅ NOUVEAU: Sommaires pour les périodes
  getSummaryByArticleRefAndPeriodeSouhaitee(
    articleRef: string,
    dateDebut: string,
    dateFin: string
  ): Observable<CommandeSummaryResponse> {
    const params = new HttpParams().set('dateDebut', dateDebut).set('dateFin', dateFin);
    return this.http.get<CommandeSummaryResponse>(
      `${this.apiUrl}/summary/article/${articleRef}/periode-souhaitee`,
      { params }
    );
  }

  getSummaryByArticleRefAndPeriodeAjout(
    articleRef: string,
    dateDebut: string,
    dateFin: string
  ): Observable<CommandeSummaryResponse> {
    const params = new HttpParams().set('dateDebut', dateDebut).set('dateFin', dateFin);
    return this.http.get<CommandeSummaryResponse>(
      `${this.apiUrl}/summary/article/${articleRef}/periode-ajout`,
      { params }
    );
  }
  ...
  exportEtatCommandes(
    ...
    } else if (mode === 'period' && dateDebut && dateFin) {
      params = params.set('dateDebut', dateDebut).set('dateFin', dateFin);
    }

    return this.http.get(`${this.apiUrl}/export/etat-commandes`, {
      params: params,
      responseType: 'blob',
    });
  }
